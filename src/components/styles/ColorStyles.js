export const themes = {
  light: {
    ...
    modal: {
      backgroundColor: "rgba(255, 255, 255, 0.6)",
      boxShadow:
        "0px, 50px, 100px, rgba(34, 79, 169, 0.3), inset 0px 0px 0px 0.5px rgba(255, 255, 255, 0.6)",
      backgroundColorFull: "rgba(255, 255, 255, 1)",
    },
  },
  ...
  modal: {
    ...
    boxShadow:
      "0px 50px 100px rgba(0, 0, 0, 0.25), inset 0px 0px 0px 0.5px rgba(255, 255, 255, 0.3)",
    backgroundColorFull: "rgba(15, 14, 71, 1)",
  },
}
